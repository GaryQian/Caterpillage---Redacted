...
public class SplashQuote : MonoBehaviour {
    ...
    string getQuote() {
        ...
        switch ((int)Random.Range(0, quoteCount - 0.0001f)) {
            ...
            case 104: return "Fidget Spinners?";
            case 105: return "RIP Harambe.";
            case 106: return "Rockets! Liftoff!";
            case 107: return "Pillage the Village!";
            case 108: return "Nacho cheese? Not-Yo-Cheese!";
            case 109: return "I specialize in Dad jokes.";
            case 110: return "Double Butter!";
            case 111: return "Dem spicy memes!";
            case 112: return "Cheese is the best.";
            case 113: return "Ni Hao!";
            case 114: return "Invest in bitcoin!";
            case 115: return "Don't eat poisonous berries.";
            case 116: return "Water is wet.";
            case 117: return "Burbs are cute and fluffy.";
            case 118: return "Sierra 117";
            case 119: return "CORAL!";
            case 120: return "Winter is coming.";
            case 121: return "Halp I've fallen and I can't get up!";
            case 122: return "42 is the answer.";
            case 123: return "Earth: Mostly harmless.";
            case 124: return "So long and thanks for all the fish";
            case 125: return "To boldly go where no man has gone before.";
            case 126: return "Bananas are slightly radioactive.";
            case 127: return "Drink more water!";
            case 128: return "Lemme take a selfie!";
            case 129: return "Blobfishes are sad :(";
            case 130: return "HOLEE MOLEE";
            case 131: return "Holy Moly!";
            case 132: return "Space Worm!";
            case 133: return "Caterpillars can fly!";
            case 134: return "Pass the mashed potatoes!";
            case 135: return "Pigs can fly?";
            case 136: return "Turtles!";
            case 137: return "Konichiwa";
            case 138: return "For honor and glory!";
            case 139: return "Hola!";
        }
