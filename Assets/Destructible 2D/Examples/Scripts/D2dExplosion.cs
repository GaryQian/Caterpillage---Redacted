	...
	public class D2dExplosion : MonoBehaviour
	{
		...
		protected virtual void Start()
		{
			if (Stamp == true)
			{
                ...
                //var coroutine = D2dDestructible.StampAllCoroutine(stampPosition, StampSize, stampAngle, StampTex, StampHardness, Mask);
                //WorldManager.wormMotion.StartCoroutine(coroutine);
            }
